    ...
    <main className="min-h-screen bg-[#F5F2ED] px-6 py-16">
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/user" className="rounded-full border border-slate-300 bg-white px-5 py-3 text-sm font-bold text-slate-900 transition-colors hover:border-ocean hover:text-ocean">Open guest view</Link>
        </div>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="max-w-3xl text-slate-600 leading-relaxed">
            This route will become the property editor: rates, photos, amenities, map coordinates, calendar blocks,
            and availability status. For now it serves as a real path with the right shell and intent.
          </p>
        </section>
      </div>
    </main>
